...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Item Name</th>
    ...
    <tbody>
    	<tr>
            ...
            <td><a href="<?php echo base_url().'Admin/deleteOrder/' . $row->order_id; ?>" class="ask"><img src="<?php echo base_url();?>assets/images/images/images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
