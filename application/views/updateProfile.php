  ...
  <div class="container">
			<div class="r">
				...
				<h1>Update Profile</h1>
					<form class="form-control" method="post" action="<?php echo base_url();?>User/updateUserDetails">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="first_name" id="name" value="<?php echo $row->first_name; ?>"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="last_name" id="name"  value="<?php echo $row->last_name; ?>"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="phone_number" id="phone"  value="<?php echo $row->phone_number; ?>"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
									<div><input type="email" class="form-control" name="email_id" id="email"  value="<?php echo $row->email_id; ?>"/> </div>
								</div>
							</div>
						</div>
						
						<div class="form-group ">
							<button type="submit"  name ='signup'id="button" class="btn btn-success btn-lg btn-block login-button">Update
							</button>
