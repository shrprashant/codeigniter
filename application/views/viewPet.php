...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <h2><strong>Pet'</strong>s Details</h2> 
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Pet ID</th>
            <th scope="col" class="rounded">Pet Name</th>
            <th scope="col" class="rounded">Breed</th>
            <th scope="col" class="rounded">Color</th>
            <th scope="col" class="rounded">Owner ID</th>
    ...
    <tbody>
       ...
       <?php
            ...
            <td> <a href="<?php echo base_url().'Admin/deletePet/' . $row->petid; ?>"class="ask"> <img src="<?php echo base_url();?>assets/images/images/images/trash.png" alt="delete" title="" border="0" /></a></td>
